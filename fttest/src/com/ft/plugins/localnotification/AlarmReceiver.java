...
import com.ft.activitys.twocordova;
...
public class AlarmReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		final String urlid = bundle.getString(URLID);
		...
		Intent notificationIntent = new Intent(context, twocordova.class);
		notificationIntent.putExtra("urlid", urlid);
